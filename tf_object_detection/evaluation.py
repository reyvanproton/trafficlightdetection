...
import sys
sys.path.append(r"C:\Users\reyva\Documents\tensorflow\bstld\evaluation")
from evaluate import evaluate as bstld_evaluate

import sys
sys.path.append(r"C:\Users\reyva\Documents\tensorflow\bstld")
from read_label_file import get_all_labels
from tf_object_detection import inference
