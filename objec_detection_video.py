...
sys.path.append(r"C:\Users\reyva\Documents\tensorflow\models\research")
...
PATH_TO_LABELS = os.path.join(CWD_PATH,'tf_object_detection','label_maps','bstld_label_map.pbtxt')
